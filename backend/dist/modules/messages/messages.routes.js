...
messagesRouter.post("/", async (req, res, next) => {
    try {
        ...
        const assistantSaved = await query("insert into messages (chat_id, role, content, model, sources, content_type, image_url) values ($1, 'assistant', $2, $3, $4::jsonb, $5, $6) returning *", [input.chatId, assistantContent, aiResponse.data.model ?? input.model, JSON.stringify(sources), contentType, imageUrl]);
